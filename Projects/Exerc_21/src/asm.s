...
wrx:    LDR R2, [R0, #UART_FR] ; status da UART
        ...
        TEQ R1, #'\r' ;verifica se foi pressionado enter
        BNEQ wrx

        BL resposta ; envia a resposta: “Sistemas Microcontrolados\r\n”
...
;----------
; resposta: responda transmistindo a mensagem “Sistemas Microcontrolados\r\n” pela UART0
...
UART_config:
        ...
        ; 8 bits, 2 stop, paridade par, FIFOs disabled, no interrupts
        LDR R1, [R0, #UART_LCRH]
        ORR R1, #01101110b
        STR R1, [R0, #UART_LCRH]
